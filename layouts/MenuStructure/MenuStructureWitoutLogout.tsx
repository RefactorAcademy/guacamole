...
import HeaderBar from '../../components/HeaderBar/HeaderBarWithoutLogout'
import Sidebar from '../../components/Sidebar'

class MenuStructureWitoutLogout extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      hasLoaded: false,
...
export default withRouter(MenuStructureWitoutLogout)
